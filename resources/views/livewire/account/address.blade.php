<div>
        ...
        <div>
            ...
            <div class="row mb-3">
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" placeholder="{{ __('Phone') }}" readonly
                        value="{{ auth()->user()->phone }}" disabled>
                </div>
                <div class="form-group col-6">
                    <label for="">{{ __('Email') }}</label>
                    <input type="text" class="form-control" placeholder="{{ __('Email') }}" readonly
            ...
            <div class="row mb-3">
                <div class="form-group col-lg-6">
                    ...
                    <select class="form-control @error('country') is-invalid @enderror" id="floatingSelect"
                        aria-label="fl-select-country" wire:model="country">
            ...
            <div class="mb-5">
                <button class="tt_btn_theme w-100" type="submit"
    ...
    <div class="alert alert-danger" role="alert">
        ...
        <p>{{ __('If you want to remove your Tallow Skin Care account, you can proceed by clicking the button below.') }}</p>
