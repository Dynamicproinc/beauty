                                ...
                                @foreach ($cart_items as $index => $item)
                                    <tr>
                                        ...
                                        <td class="text-nowrap text-end">
                                            <div class="">
                                                <h6 class="mb-0 tt-text-xs mb-3 text-nowrap">
                                                    {{ number_format($item['price'] * $item['quantity'], 2, ',', ' ') }}
                                                    €</h6>
                                                <button class="btn btn-sm btn-link text-danger p-0"
                                                    wire:click="removeItem({{ $index }})">{{ __('Remove') }}</button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
            ...
            <div class="col-lg-4">
                <div class="payment-summary">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <span class="mb-0 tt-text-xs text-uppercase">{{ number_format($total, 2, ',', '.') }} €
                        </span>
                    ...
                    <div>
                        <a href="{{ route('shop.checkout') }}" class="tt_btn_theme w-100"
                            title="{{ __('Buy now tallow skincare product') }}">{{ __('Checkout') }}</a>
                    </div>
                </div>
