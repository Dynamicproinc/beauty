...
<div>
   <div class="container my-5">
    ...
    <div class="privacy-container">
        ...
        <h1 class="mb-4 text-center">Izjava o privatnosti</h1>
        ...
        <ul>
            <li>Ime i prezime</li>
            <li>Email adresa</li>
            <li>Broj telefona (ako je dostavljen)</li>
            <li>Adresa za dostavu i naplatu (ako je primjenjivo)</li>
            <li>Podaci o narudžbi</li>
            <li>Informacije poslane putem kontakt obrazaca</li>
        ...
        <ul>
            ...
            <li>Poštivanje zakonskih obveza</li>
        ...
        <ul>
            ...
            <li>Računovodstvenim ili pravnim savjetnicima</li>
