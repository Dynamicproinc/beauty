     ...
     <div class="container">
         <div class="row">
             ...
             <div class="col-md-4 mb-4">
                 ...
                 <a href="{{ route('shop.subscribe') }}" class="btn btn-dark w-100 rounded-0">
                     {{ __('Subscribe') }}
                 </a>
             </div>
             <!-- Company -->
             ...
             <div class="col-6 col-md-3">
                 <div>
                     ...
                     <a href="tel:+385996680498" class="text-primary-muted">+385 99 668 0498</a>
